<script>
  export let title = "Книги с мисия | Логос – Аз и Ти";
...
<div class="heading">
  <div class="heading-container">
    <div id="h-left">
      <h1>Книги с мисия</h1>
      <p>
        Тук ще намерите книги, които сме създали с мисията да вдъхновяват, образоват и подкрепят децата и родителите в тяхното развитие и ежедневие. Всяка книга е създадена с внимание към детайлите и с цел да предостави полезна информация и вдъхновение за по-добър живот.
      </p>
...
<div class="books">
  <div class="books-container">
    <h2>Забавна логопедия – пътешествия в света на А-Ъ</h2>
    <div class="books-content">
      <div class="subsection">
        <p class="intro-text">
          ✨ Понякога има дни, в които се случва магия… и остават завинаги в сърцето. 🧡
        </p>
        <p>
          С любезното съдействие и подкрепа на издателство "Или - Мили", на <strong>24.03.2026 г.</strong> се състоя представянето на книгата <strong>„Забавна логопедия – пътешествия в света на А-Ъ"</strong>, една сбъдната мечта, родена от любовта, грижата и отдадеността към децата и техните семейства, от уважението към професията и обичта към книгата.
        </p>
        <p>
          <strong>Това не беше просто представяне на книга…</strong>
        </p>
        <p>
          Това беше среща на сърца. Среща на хора, които вярват, че зад всяка дума стои свят, който чака да бъде открит. Среща, изпълнена с усмивки, вълнение, вдъхновение и пълни сърца…
        </p>
        <p>
          И тогава разбрах – всичко има смисъл.
        </p>
        <p>
          Благодарим от сърце на всички колеги и приятели, които бяхте част от този ден – за топлината, подкрепата и споделената емоция. За доверието. За присъствието. За това, че вървим заедно по този път. За това, че вярвате и подкрепяте каузата.
        </p>

        <h4 style="margin-top: 25px; margin-bottom: 15px; color: var(--orange); font-size: 1.2rem;">Специални благодарности на:</h4>
        <ul style="margin-bottom: 20px !important; list-style: none; padding-left: 20px;">
          <li style="margin-bottom: 12px;">
            <strong>🧡 Издателство "Или-Мили"</strong> – за професионализма, отдадеността, за всеки изпипан детайл в подготовката и представянето на книгата, както и за прекрасните подаръци за всички гости.
          </li>
          <li style="margin-bottom: 12px;">
            <strong>🧡 Osteria Tartufo</strong> - за уютната атмосфера и топлото гостоприемство, които допринесоха този ден да бъде още по-специален.
          </li>
          <li style="margin-bottom: 12px;">
            <strong>📸 Evgeni Mishev Photography</strong> - за магията в кадър, за таланта да улавя емоцията и да превръща миговете в незабравими спомени.
          </li>
          <li style="margin-bottom: 12px;">
            <strong>📸 Bogdana Ivanova</strong> - за сърцето, вложено във всеки детайл от събитието, за усмивките и магичните кадри, дакосващи сърцето.
          </li>
          <li style="margin-bottom: 12px;">
            <strong>🧡 Нашите семейства</strong> – за силата, подкрепата и вярата.
          </li>
          <li>
            <strong>🧡 Maria-Paola Tuputi</strong> - за съвместната работа и сърцето, вложено в създаването на тази книга.
          </li>
        </ul>

        <div class="book-images">
          <div class="book-cover">
            <img src="pages/knigi/zabavna-logopedia-front.jpg" alt="Забавна логопедия – отпред" />
            <p class="image-label">Корица отпред</p>
          </div>
          <div class="book-cover">
            <img src="/pages/knigi/zabavna-logopedia-back.jpg" alt="Забавна логопедия – отзад" />
        ...
        <ul style="margin: 15px 0 20px 0 !important; list-style: none; padding-left: 0;">
          <li style="margin-bottom: 10px; font-size: 1.2rem;">понякога една книга не е просто книга.</li>
          <li style="margin-bottom: 10px; font-size: 1.2rem;">Тя е път.</li>
          <li style="margin-bottom: 10px; font-size: 1.2rem;">Тя е мисия.</li>
          <li style="margin-bottom: 10px; font-size: 1.2rem;">Тя е любов, превърната в думи.</li>
          <li style="margin-bottom: 10px; font-size: 1.2rem;">А когато тези думи достигнат и докоснат детско сърце…</li>
          <li style="margin-bottom: 10px; font-size: 1.2rem;">те се превръщат в <strong>смелост да говори!</strong></li>
        </ul>
        <p style="color: var(--orange); font-weight: 700;">
          Обич.
        </p>

        <div class="book-link-container">
          <a href="https://ilimili.bg/products/zabavna-logopedia" target="_blank" class="book-link" title="Вижте книгата в издателство Или-Мили">
        ...
        <div class="event-images">
          <div class="event-image">
            <img src="/logos/nav-logo.png" alt="Представяне на книга - снимка 1" />
          </div>
          <div class="event-image">
            <img src="/logos/nav-logo.png" alt="Представяне на книга - снимка 2" />
          </div>
          <div class="event-image">
            <img src="/logos/nav-logo.png" alt="Представяне на книга - снимка 3" />
          </div>
        </div>

        <p style="text-align: center; margin-top: 25px;">
          <a href="/galeriya?category=Книги%20с%20мисия#gallery" class="gallery-link">Вижте повече снимки от представянето в галерията</a>
        </p>
      </div>
    </div>
  </div>
...
<style>
  ...
  * {
  ...
  .book-cover:hover {
    ...
    box-shadow: 0 8px 20px rgba(247, 162, 116, 0.3);
  }
