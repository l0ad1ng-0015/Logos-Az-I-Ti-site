<footer>
  <div class="columns">
    <div class="column" style="margin-left: 0 !important;">
      <div id="heading">
        <img
          class="logo"
      ...
      <ul>
        ...
        <li style="margin-top: 0 !important">
          <a href="https://maps.app.goo.gl/Bocn4jwKVaSc9Lj18"
            >бл.411, вх."Г" - София</a
          >
        </li>
        <li><a href="tel:+359876860602">+359 876 860 602</a></li>
        <li>
          <a href="mailto:logos_aziti@abv.bg" target="_blank"
            >logos_aziti@abv.bg</a
          >
        </li>
      </ul>
    </div>
    ...
    <div class="column">
      ...
      <ul>
        ...
        <li>
          <a href="/privacy-policy" target="_blank">Политика за поверителност</a
          >
        </li>
      </ul>
    </div>
    <div class="column">
      ...
      <div>
        <div id="socials">
          <a
            href="https://www.facebook.com/people/%D0%9E%D0%A6-%D0%9B%D0%BE%D0%B3%D0%BE%D1%81-%D0%90%D0%B7-%D0%B8-%D0%A2%D0%B8/61564854236122/"
            target="_blank"
          >
            <svg
              width="35px"
          ...
          <div class="btns">
            ...
            <a href="/kontakti">Запиши Час</a>
            </button>
            <button class="button" id="knigi" style="background-color: var(--orange);">
            <a href="/knigi-s-misiya">Книги с мисия</a>
            </button>
        </div>
      </div>
    </div>
  ...
  <div
    id="copy"
    style="width: 100%; max-width: 1000px; margin-top: 20px; text-align: center; border-top: 1px solid #cccccc6d; padding-top: 11px;"
  >
    <p>&copy; 2025 ОЦ "Логос - Аз и Ти". Всички права запазени.</p>
  </div>
</footer>
