...
<div class="heading">
    <div class="heading-container">
        <div id="h-left">
            ...
            <p>Намерете отговори на най-често срещаните въпроси сред нашите клиенти и отговори на тях.</p>
        </div>
        <div id="h-right">
...
<div class="faq">
 ...
 <div class="cta-section-container">
     <h2>Не намерихте отговор на въпроса си?</h2>
    <div class="cta-section">
        <h3 class="section-intro">Свържете се с нас директно и нашите специалисти ще отговорят на всички ваши въпроси относно остеоманипулативната терапия.</h3>
