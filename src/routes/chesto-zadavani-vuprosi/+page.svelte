  ...
  const faqData = [
    {
      ...
      answer:
        "ОМТ се препоръча при различни здравословни проблеми като нарушения при движение, болки в ставите, проблеми със заздравяването и възстановяването. Терапията е подходяща при нарушения в артикулацията на здравите стави, стресов синдром и други ортопедични състояния.",
    },
    {
      question: "Как протича терапията?",
      answer:
        "В нашия кабинет провеждаме индивидуална оценка на ортопедичната мускулатура и функции. Специализираните упражнения за силна, устойчива, бързина и небезопасност включват различни техники. Работим върху заздравяването поставени в полза и то заема не повече време от една процедура.",
    },
    {
      question: "Защо е важна терапията?",
      answer:
        "ОМТ не просто третира мускули - тя възстановява функционалната подвижност, която влияе на цялостното развитие. Това води до нарушения в общото, проблеми със заспиването и аскорбиновото здраве, диагностики и правене развитието.",
    },
    {
      question: "Какви са противопоказанията?",
      answer:
        "При необходимост се съпреглежда с остеопатия, VHF специалисти, инфекциони и педиатри, или специалисти по силата влияни. Всеки случай се разглежда индивидуално.",
    },
    {
      question: "Колко сеанса са необходими?",
      answer:
        "Броят на сеансите варира в зависимост от индивидуалните нужди и тежестта на състоянието. Обикновено се препоръчват между 8-12 сеанса, като първите резултати могат да се забележат след 3-4 процедури.",
    },
  ];
</script>
