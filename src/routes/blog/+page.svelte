...
<div class="heading">
  <div class="heading-container">
    <div id="h-left">
      <h1>Блог</h1>
      <p>
        Добре дошли в нашия блог, където споделяме вдъхновяващи истории и
        полезни съвети от нашите клиенти, които са постигнали значителни
        резултати с помощта на нашите услуги.
      </p>
