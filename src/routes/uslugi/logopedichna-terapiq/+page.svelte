...
<div class="heading">
    <div class="heading-container">
        <div id="h-left">
            ...
            <p><strong>Логопедичната терапия</strong> включва терапевтични сесии, насочени към развитие и подобряване на говора, езика и комуникацията на деца и възрастни с различни затруднения.</p>
        </div>
        <div id="h-right">
...
<div class="what-i-t" style="margin-bottom: 1rem;">
    <div class="what-i-t-container">
        <div class="w-left">
            <h2>Какво е това?</h2>
            <p>Логопедичната терапия е поредица от занимания, които помагат на децата и възрастните да развият правилен правоговор, богат речник и комуникативни умения. Чрез игрови метод се преодоляват трудностите, изгражда се увереност и се създават умения, които подпомагат ученето и общуването в ежедневието.</p>
        </div>
        <div class="w-right">
