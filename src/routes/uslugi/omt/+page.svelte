...
<div class="heading">
    <div class="heading-container">
        <div id="h-left">
            <h1>ОМТ</h1>
            <p><strong>Орофациалната миофункционална терапия</strong> подпомага правилното функциониране на езика, устните и дишането чрез специални упражнения, които укрепват мускулатурата.</p>
        </div>
        <div id="h-right">
...
<div class="what-i-t" style="margin-bottom: 1rem;">
    <div class="what-i-t-container">
        <div class="w-left">
            ...
            <p>Орофациалната миофункционална терапия (ОМТ) е съвременен терапевтичен подход, който се фокусира върху правилната функция на езика, устните, челюстта и дихателните пътища. Целта ѝ е да се възстановят естествени модели на преглъщане, говор, дишане и мускулен баланс, които често са нарушени при деца и възрастни.</p>
        </div>
        <div class="w-right">
    ...
    <div class="why-is-it-im-container">
        ...
        <div class="why-is-it-im-content">
            <div class="subsection">
                <p>ОМТ не просто тренира мускули – тя възстановява фундаментални навици, които влияят на цялостното развитие. Когато езикът стои между зъбите или устата е винаги отворена, това води до:</p>
                ...
                <p class="emphasis">Чрез ОМТ ние възстановяваме естествения баланс и подпомагаме детето или възрастния в неговото говорно, дихателно и орално развитие.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="form-content">
            ...
            <form on:submit={handleSubmit} class="contact-form">
                <div class="subsection" style="margin-bottom: 1.5rem;">
                    <p style="font-size: larger;">Свържете се с нас, за да определим дали орофациалната терапия е подходяща за вашето дете или за вас.</p>
...
<style>
    ...
    *{box-sizing:border-box;margin:0;padding:0;font-family:"Cormorant Garamond",serif;}
    ...
    @media screen and (max-width: 755px) {
        ...
        /* ---- 3. Why necessary? ---- */
        .why-nec-content, .how-is-it-g-content, .why-is-it-im-content, .work-in-team-content, .contact-content {
            padding: 30px 20px;
        }
