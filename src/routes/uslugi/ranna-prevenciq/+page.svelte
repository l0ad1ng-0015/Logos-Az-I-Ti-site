...
<div class="heading">
    <div class="heading-container">
        <div id="h-left">
            ...
            <p>Открийте защо <strong>ранната превенция</strong> е ключът към уверено развитие на вашето дете. Чрез наблюдение, игри и експертни насоки заедно подкрепяме езиково-говорните, когнитивните и социалните умения от най-ранна възраст.</p>
        </div>
        <div id="h-right">
...
<div class="main-section">
    <h2>
        <!-- <span class="icon">👨‍👩‍👧‍👦</span> -->
        3. Подкрепя не само детето, но и семейството
    </h2>
    <div class="content-card">
        <h3 class="section-intro">Родителят получава:</h3>
        <div class="family-benefits">
            ...
            <div class="benefit-item">
                <span class="benefit-icon">🏠</span>
                <div>
                    <h4>Индивидуални препоръки и насоки</h4>
                    <p>Конкретни указания какво да наблюдавате и правите у дома</p>
                </div>
            </div>
            <div class="benefit-item">
                <span class="benefit-icon">🤗</span>
                <div>
                    <h4>Усещане, че не сте сами</h4>
                    <p>Професионална подкрепа в грижата за детето</p>
                </div>
            </div>
        </div>
    </div>
...
<style>
    ...
    *{box-sizing:border-box;margin:0;padding:0;font-family:"Cormorant Garamond",serif;}
    ...
    /* Евентуакмо може да се ползва за спан иконките */
    /* .icon {
        width: 50px;
        height: 50px;
        background: #ff9d6b;
