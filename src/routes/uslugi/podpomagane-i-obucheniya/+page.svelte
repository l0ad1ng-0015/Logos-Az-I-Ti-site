...
<div class="heading">
  <div class="heading-container">
    <div id="h-left">
      ...
      <p>
        <strong>В „Логос – Аз и Ти“</strong> предлагаме подкрепа и обучения за
        <strong>деца, тийнейджъри и възрастни</strong> – от подготовка по български
        език, математика и английски до оценка на училищна готовност.
      </p>
    </div>
    <div id="h-right">
      <svg
  ...
  <div class="child-support-container">
    ...
    <div class="child-support-content">
      ...
      <ul style="margin-bottom: 0 !important;">
        <li>
          Преодоляване проблемите в обучителния процес и повишаване на знанията,
          уменията и компетенциите на децата;
        </li>
        <li>
          Допълващи терапии и обучения на деца в предучилищна и начална училищна
          възраст;
        </li>
        <li>
          Подпомагане на учебния процес по български език и литература и
          математика в начален и среден курс на обучение;
        </li>
        <li>Подпомагане на учебния процес по английски език;</li>
        <li>
          Оценка на училищната готовност на децата и подготовка за постъпване в
          училище;
        </li>
      </ul>
    </div>
  ...
  <div class="child-training-container">
    ...
    <div class="child-training-content">
      <div class="subsection">
        ...
        <ul
          style="margin-top: 5px !important; margin-bottom: 30px !important; font-size: 1.2rem !important"
          class="numbered-list"
        >
          <li>
            Допълнителна образователна дейност: Чуждоезиково обучение по
            английски език
          </li>
          <li>
            Обучението по английски език се провежда в рамките на една учебна
            година – от 1 октомври до 31 май и е насочено към постигане на
            сертификатни нива към Cambridge Assessment English.
          </li>
          <li>
            Обучението се води от висококвалифицирани преподаватели с опит в
            преподаването на английски език в различни възрастови групи и с
            професионални квалификации за работа по международни езикови
            стандарти.
          </li>
        </ul>
      </div>
      <div class="subsection-2">
        ...
        <ul style="margin-bottom: 30px !important;">
          ...
          <li>
            Общо натоварване: 16 учебни часа на месец / 128 часа за учебната
            година
          </li>
          <li>
            Входящ тест за определяне на индивидуалното езиково ниво при
            постъпване
          </li>
        </ul>
      </div>
      <div class="subsection-2">
        ...
        <ul style="margin-bottom: 30px !important;">
          <li>
            Предучилищна възраст (5–6 г.): ранно чуждоезиково обучение чрез
            игри, песни и комуникативни дейности
          </li>
          <li>
            Начален етап (1- 4 клас): изграждане на стабилна езикова основа чрез
            интерактивни методи
          </li>
          <li>
            Тийнейджъри (5- 12 клас): целенасочена подготовка по нива на Общата
            европейска езикова рамка (А1–B2), с възможност за полагане на изпити
            към Cambridge
          </li>
          <li>
            Възрастни: практическо овладяване на езика за лични, академични или
            професионални цели по утвърдени международни методики.
          </li>
        </ul>
      </div>
      <div class="subsection-2">
        ...
        <ul style="margin-bottom: 0 !important;">
          <li>
            Развитие на четирите основни езикови компонента: слушане, говорене,
            четене и писане
          </li>
          <li>
            Усвояване на богат речников запас и граматични структури, съобразени
            с нивото
          </li>
          <li>
            Стимулиране на уверено устно изразяване чрез ролеви игри, диалози ,
            презентации и фестиволни уроци
          </li>
          <li>
            Подготовка за международно признати сертификати (YLE Starters,
            Movers, Flyers; A2 Key; B1 Preliminary; B2 First)
          </li>
          <li>
            Насърчаване на самостоятелност и мотивация за учене чрез
            интерактивни методи и персонализиран подход
          </li>
          <p class="emphasis">
            💡 Обучението съчетава традиционни и съвременни подходи, за да
            отговори на индивидуалните нужди на всеки курсист, независимо от
            възрастта или началното ниво. Атмосферата е подкрепяща и
            вдъхновяваща с фокус върху ефективното и уверено използване на
            английски език в реални ситуации
          </p>
        </ul>
      </div>
    </div>
    ...
    <div class="form-content">
      ...
      <form on:submit={handleSubmit} class="contact-form">
        ...
        <div class="info" style="margin-bottom: 1.5rem; font-size: 1.3rem">
          <p>
            Свържете се с нас за повече информация относно програмата, графика
            или входящия тест:
          </p>
          <ul
        ...
        <h3 style="margin-top: 2rem;">
          Нашият екип с радост ще отговори на всички въпроси и ще ви насочи към
          най-подходящото ниво за Вашето дете!
        </h3>
      </form>
    </div>
  </div>
