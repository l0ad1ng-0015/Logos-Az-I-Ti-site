<script>
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Честотата се определя след направената диагностика, оценка на езиково-говорното развитие и назначената терапия,свързана с затрудненията на детето и съобразена с индивидуалните му нужди– 1-2 пъти седмично или 1- 3 пъти седмично.",
    },
  ];
</script>
