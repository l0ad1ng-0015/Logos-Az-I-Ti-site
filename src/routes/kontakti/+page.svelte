...
<div class="heading">
    <div class="heading-container">
        <div id="h-left">
            <h1>Контакти</h1>
            <p>Свържете се с нас – тук ще намерите локация, телефони, имейли и контактна форма за вашите въпроси. Ако желаете да запишете час, обадете ни се – ние сме тук, за да съдействаме.</p>
        </div>
        <div id="h-right">
