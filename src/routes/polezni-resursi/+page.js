...
export const load = async () => {
  try {
    ...
    },
    {
      ...
      description:
        "Потопете децата в празничното настроение с настъпващия Великден. Нашите тематични и авторски материали са създадени с грижа към децата да усвояват знания чрез игра.",
